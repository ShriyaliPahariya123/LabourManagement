...
import MainListItems,{mainListItems,secondaryListItems,thirdListItems} from '../admin/MainListItems'
...
export default function Dashboard(props) {
  ...
  const [view,setView]=React.useState(<showCount/>)
  ...
  const checkSession=()=>{
    ...
    {
     props.history.replace({pathname:'/00001e'})
    }
    else{
    ...
    return(
     <div>
       <StyledBadge
        ...
        variant="dot"
      >
        <Avatar alt="Remy Sharp" src={`${BaseUrl}/images/images.png`}  onClick={handleClickAM} className={classes.small}/>
      </StyledBadge>
     <Menu
           id="simple-menuAM"
           anchorEl={anchorElAM}
    ...
    <div className={classes.root}>
      ...
      <AppBar position="absolute" className={clsx(classes.appBar, open && classes.appBarShift)}>
        <Toolbar className={classes.toolbar}>
          ...
          <img src="http://localhost:3000/logo.png" height='50px' width='150px'/>
          </Typography>
